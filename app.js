...
function renderProfile(){const box=$('#profilePage');if(!me){box.innerHTML=`<div class="profile-login"><div class="profile-login-icon">${icon('user')}</div><h1>پروفایل</h1><p>برای استفاده از کتابخانه و امکانات حساب کاربری وارد MangaNova شو.</p><button class="primary" onclick="auth()">ورود / ثبت‌نام</button></div>`;return}
